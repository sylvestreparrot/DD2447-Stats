...
# generation of the parameters phi,alpha,beta
parameters = sv_parameter_generator(saveOpt=True, displayOpt=True, filename='myparameters.csv')

# generation of a sequence of 500 log-returns
T = 500
yt = sv_data_generator(parameters, T, displayOpt=True, saveOpt=True, filename='mydata.csv')